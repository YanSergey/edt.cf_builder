...
public class V8ExtendedLauncher extends AbstractRuntimeComponentExecutor {
    ...
    private ComponentExecutorInfo<ILaunchableRuntimeComponent, IDesignerSessionThickClientLauncher> v8Launcher;

    public V8ExtendedLauncher(
        ComponentExecutorInfo<ILaunchableRuntimeComponent, IDesignerSessionThickClientLauncher> v8Launcher)
    {
	...
	public String executeRuntimeProcessCommandEx(RuntimeExecutionCommandBuilder command,
        ...
        return this.executeRuntimeProcessCommand(command, v8Launcher.getComponent().getInstallation(), infobase,
            arguments);
	...
	private void closeDesignerSession(RuntimeExecutionArguments arguments, InfobaseReference infobase)
        ...
        v8Launcher.getExecutor().closeDesignerSession(v8Launcher.getComponent(), infobase,
				arguments);
