...
//								temptXMLPath);
                        ...
                        v8Launcher.getExecutor()
                            .importFullXmlToInfobase(v8Launcher.getComponent(), projectInfo.getDeploymentInfobase(),
...
//								arguments);
                        v8Launcher.getExecutor()
                            .updateDatabaseConfiguration(v8Launcher.getComponent(),
                            projectInfo.getDeploymentInfobase(), null, arguments);
						break;
...
//				buildArguments(projectInfo.getDeploymentInfobase()), null, destinationFile.getPath());
        ...
        v8Launcher.getExecutor()
            .exportCfFromInfobase(v8Launcher.getComponent(), projectInfo.getDeploymentInfobase(),
            buildArguments(projectInfo.getDeploymentInfobase()), null, destinationFile.getPath());
	}
